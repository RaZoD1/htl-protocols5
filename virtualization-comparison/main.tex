...
\title{	
	...
	{\huge Vergleich: Hypervisor}\\ % The assignment title
...
def luftballons():
	print("99 red luftballons")
	print("floating in the summer sky")
	print("panic bells, it's red alert")
	print("there's something here from somewhere else")
	print("the war machine springs to life")
	print("opens up one eager eye")
	print("focusing it on the sky")
	print("99 red luftballons go by")
\end{minted}
